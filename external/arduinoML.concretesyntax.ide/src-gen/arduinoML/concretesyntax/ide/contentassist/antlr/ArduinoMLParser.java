...
public class ArduinoMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ArduinoMLGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getAppAccess().getAlternatives_1(), "rule__App__Alternatives_1");
			...
			builder.put(grammarAccess.getAppAccess().getGroup_1_0(), "rule__App__Group_1_0__0");
			builder.put(grammarAccess.getAppAccess().getGroup_1_1(), "rule__App__Group_1_1__0");
			...
			builder.put(grammarAccess.getAppAccess().getMonitoringAssignment_0_2(), "rule__App__MonitoringAssignment_0_2");
			builder.put(grammarAccess.getAppAccess().getNameAssignment_1_0_1(), "rule__App__NameAssignment_1_0_1");
			builder.put(grammarAccess.getAppAccess().getInitial_modeAssignment_1_0_4(), "rule__App__Initial_modeAssignment_1_0_4");
			builder.put(grammarAccess.getAppAccess().getBricksAssignment_1_0_8(), "rule__App__BricksAssignment_1_0_8");
			builder.put(grammarAccess.getAppAccess().getBricksAssignment_1_0_9(), "rule__App__BricksAssignment_1_0_9");
			builder.put(grammarAccess.getAppAccess().getModesAssignment_1_0_12(), "rule__App__ModesAssignment_1_0_12");
			builder.put(grammarAccess.getAppAccess().getModesAssignment_1_0_13(), "rule__App__ModesAssignment_1_0_13");
			builder.put(grammarAccess.getAppAccess().getModesAssignment_1_1_1(), "rule__App__ModesAssignment_1_1_1");
