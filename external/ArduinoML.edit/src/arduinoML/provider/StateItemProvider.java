...
public class StateItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArduinoMLPackage.Literals.STATE__TRANSITIONS_STATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArduinoMLPackage.Literals.STATE__ACTIONS,
				 ArduinoMLFactory.eINSTANCE.createAction()));

		newChildDescriptors.add
			(createChildParameter
				(ArduinoMLPackage.Literals.STATE__TRANSITIONS_STATE,
				 ArduinoMLFactory.eINSTANCE.createTransitionState()));
	}
